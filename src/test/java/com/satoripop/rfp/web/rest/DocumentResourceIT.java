...
class DocumentResourceIT {
    ...
    private static final DocumentType DEFAULT_DOCUMENT_TYPE = DocumentType.EXCEL;
    private static final DocumentType UPDATED_DOCUMENT_TYPE = DocumentType.WORD;
    ...
    public static Document createEntity(EntityManager em) {
        Document document = new Document().title(DEFAULT_TITLE).content(DEFAULT_CONTENT).documentType(DEFAULT_DOCUMENT_TYPE);
        return document;
    }
    ...
    public static Document createUpdatedEntity(EntityManager em) {
        Document document = new Document().title(UPDATED_TITLE).content(UPDATED_CONTENT).documentType(UPDATED_DOCUMENT_TYPE);
        return document;
    }
    ...
    void putExistingDocument() throws Exception {
        ...
        updatedDocument.title(UPDATED_TITLE).content(UPDATED_CONTENT).documentType(UPDATED_DOCUMENT_TYPE);
    ...
    void fullUpdateDocumentWithPatch() throws Exception {
        ...
        partialUpdatedDocument.title(UPDATED_TITLE).content(UPDATED_CONTENT).documentType(UPDATED_DOCUMENT_TYPE);
