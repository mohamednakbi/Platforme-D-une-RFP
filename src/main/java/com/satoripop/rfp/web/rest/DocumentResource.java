...
/**
 * REST controller for managing {@link com.satoripop.rfp.domain.Document}.
 */
@RestController
...
public class DocumentResource {
    ...
    public ResponseEntity<List<DocumentDTO>> searchDocumentBytitle(
        @RequestParam String title,
        @ParameterObject Pageable pageable,
        UriComponentsBuilder uriBuilder
    ) {
        Page<DocumentDTO> resultPage = documentService.searchBytitle(title, pageable);
