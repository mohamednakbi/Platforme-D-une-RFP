...
/**
 * REST controller for managing {@link com.satoripop.rfp.domain.Role}.
 */
@RestController
...
public class RoleResource {
    ...
    public ResponseEntity<List<RoleDTO>> searchRolesByName(
        @RequestParam String name,
        @ParameterObject Pageable pageable,
        UriComponentsBuilder uriBuilder
    ) {
        Page<RoleDTO> resultPage = roleService.searchByName(name, pageable);
