...
<#elseif section = "form">
<div class="card card-3" style="width:90%; height: 95% ; margin-left: 5%;">
...
<#if passwordRequired>
<div class="input-group-register" style="margin-right: 50px; margin-top: 50%;" >
...
<div class="input-group-register" style="margin-right: 50px">
